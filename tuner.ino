...
////////////////////////////////////////////////////////////////////////////////
  ...
  // lib config
  #define _LCDML_DISP_cfg_button_press_time          20    // button press time in ms
  ...
  //stepper stuff
  BasicStepperDriver stepperC1(MOTOR_STEPS, 55, 54, 38);
...
//LCDMenuLib_add(id, group    , prev_layer_id   , new_element_num , lang_char_array  , callback_function)
  LCDML_DISP_add (0, _LCDML_G1, LCDML_root      , 1               , "Tracker"        , LCDML_FUNC);
  LCDML_DISP_add (1, _LCDML_G1, LCDML_root_1    , 1               , "Start"          , LCDML_FUNC);
  LCDML_DISP_add (2, _LCDML_G1, LCDML_root_1    , 2               , "Stop"           , LCDML_FUNC);

  LCDML_DISP_add (3, _LCDML_G1, LCDML_root      , 2               , "Setup"          , LCDML_FUNC_information);
  LCDML_DISP_add (4, _LCDML_G1, LCDML_root_2    , 1               , "Motor Speed"    , LCDML_FUNC);
  LCDML_DISP_add (5, _LCDML_G1, LCDML_root_2    , 2               , "Go to start"    , LCDML_FUNC_tuneC1);
  LCDML_DISP_add (6, _LCDML_G1, LCDML_root_2    , 3               , "Go to end"      , LCDML_FUNC);
  LCDML_DISP_add (7, _LCDML_G1, LCDML_root      , 3               , "About"          , LCDML_FUNC_information);
